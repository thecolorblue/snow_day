...
import { validateAndRewriteParagraph, generateAndUploadAudio, generateQuestion, Question, FASegment, FAWord } from '../lib/story-utils';
...
export class StoryGenerator {
  ...
  async save(storylineData: ParsedStoryline, paragraphs: ProcessedParagraph[]) {
    ...
    await prisma.$transaction(async (tx) => {
      for (const [index, paraData] of paragraphs.entries()) {
        ...
        for (const q of paraData.questions) {
